...
setId : function () {
	if ( this.id ) {
		console.log("data.Controller.setId    Returning existing this.id: " + this.id);
		return this.id;
	}
	this.id 	= 	registry.getUniqueId(this.name);
	console.log("data.Controller.setId    this.id: " + this.id);
	console.log("data.Controller.setId    registry: ");
