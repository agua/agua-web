/* PROJECT METHODS INHERITED BY Agua.js */

console.log("Loading plugins.core.Agua.Project");
...
// RETURN A SORTED COPY OF 
	...
	console.log("Agua.Project.getProjects    projects:");
...
// RETURN true IF A PROJECT EXISTS IN projects
	...
	//console.log("Agua.Project.isProject    Agua.data:");
	//console.dir({Agua_data:Agua.data});

	var projects = this.getProjects();
	//console.log("Agua.Project.isProject    projects:");
	//console.dir({projects:projects});
