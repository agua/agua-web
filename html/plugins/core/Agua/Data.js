/* DATA METHODS INHERITED BY  Agua.js
 *
  SUPPLEMENTED BY Common.js WHICH Agua.js ALSO INHERITS).
...
console.log("Loading plugins.core.Agua.Data");
...
removeData : function(name, object, keys) {
	...
	console.log("Data.removeData    this: ", this);
	console.log("Data.removeData    this.data: ", this.data);
