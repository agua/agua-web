...
doPut : function (inputs) {
	console.log("Common.Util.doPut    caller: " + this.doPut.caller.nom);
...
doXhr : function (inputs, xhrType) {
	console.log("    Common.Util.doXhr    caller: " + this.doPut.caller.nom);
...
attachPane : function (childNode) {
	...
	console.log("Common.Util.attachPane    this.mainTab.id: " + this.mainTab.id);
	this.mainTab.set('id', registry.getUniqueId("attachPoint"));
	console.log("Common.Util.attachPane    FINAL this.mainTab.id: " + this.mainTab.id);
	...
	if ( this.attachPoint.addChild ) {
		...
		console.log("Common.Util.attachPane    this.attachPoint.selectChild: ", this.attachPoint.selectChild);
	...
	console.log("Common.Util.attachPane    END this.attachPoint.addChild");
},
// CSS
...
fetchJson : function(url) {
	console.log("Common.Util.fetchJson    url: ", url);
	return this.fetchSyncJson(url, 5000);
},
fetchSyncJson : function(url, timeout) {
	//console.log("Common.Util.fetchSyncJson    url: ", url);
    ...
    dojo.xhrGet({
        ...
        load: function(response) {
            //console.log("Common.Util.fetchSyncJson    response: ", response);
			jsonObject = response;
	    },
        // The error handler
        error: function() {
            console.log("Common.Util.fetchSyncJson    Error, response: ", response);
        }
    });
