...
console.log("%cplugins/dojox/layout/FloatingPane    LOADING", "color: blue");
	
define([
	"dojo/_base/declare",
	"dojox/layout/FloatingPane",
	"plugins/dojox/layout/Dock",
	"dojo/dnd/Moveable",
...
console.log("%cplugins/dojox/layout/FloatingPane    COMPLETED", "color: blue");
