...
console.log("%cplugins/dojox/widget/_RollingListPane    LOADING", "color: blue");

dojo.experimental("plugins/dojox/widget/_RollingListPane");
...
///////}}}}}}}
	...
	startup: function(){
		console.group("plugins.dojox.widget._RollingListPane    " + this.id + "    startup");

		console.log("%cplugins.dojox.widget._RollingListPane.startup    START", "color: blue");

		if(this._started){ return; }
		console.log("%cplugins.dojox.widget._RollingListPane.startup    DOING this.store.getFeatures()['dojo.data.api.Notification']", "color: blue");
		...
		console.log("%cplugins.dojox.widget._RollingListPane.startup    DOING this.connect(this.focusNode || this.domNode, 'onkeypress', '_focuskey')", "color: blue");
		this.connect(this.focusNode||this.domNode, "onkeypress", "_focusKey");
		this.parentWidget._updateClass(this.domNode, "Pane");
	
		console.log("%cplugins.dojox.widget._RollingListPane.startup    BEFORE this.inherited()", "color: blue");
		this.inherited(arguments);
		console.log("%cplugins.dojox.widget._RollingListPane.startup    AFTER this.inherited()", "color: blue");
	
		this._onMinWidthChange(this.minWidth);

		console.log("%cplugins.dojox.widget._RollingListPane.startup    END", "color: blue");

		console.groupEnd("plugins.dojox.widget._RollingListPane    " + this.id + "    startup");
	},
	...
	cancel: function() {
		console.log("%cplugins.dojox.widget._RollingListPane.cancel    caller: " + this.cancel.caller.nom, "color: blue");
		
		console.log("%cplugins.dojox.widget._RollingListPane.cancel    ", "color: blue");
	},
	onLoad: function() {
		console.log("%cplugins.dojox.widget._RollingListPane.onLoad    ", "color: blue");
	},
	...
	_load: function(){
		...
		console.log("%cplugins.dojox.widget._RollingListPane._load    START", "color: blue");
		...
		if(this.items){
			...
			console.log("%cplugins.dojox.widget._RollingListPane._load    BEFORE this._doQuery()", "color: blue");
			this._doQuery();
			console.log("%cplugins.dojox.widget._RollingListPane._load    AFTER this._doQuery()", "color: blue");
		}
		console.log("%cplugins.dojox.widget._RollingListPane._load    END", "color: blue");
	},
	...
	_doQuery: function(){
		...
		console.log("plugins.dojox.layout._RollingListPane._doQuery    START");

		if(!this.domNode){return;}
		var preload = this.parentWidget.preloadItems;

		console.log("plugins.dojox.layout._RollingListPane._doQuery    preload: " + preload);
		
		preload = (preload === true || (this.items && this.items.length <= Number(preload)));
		if(this.items && preload){

			console.log("plugins.dojox.layout._RollingListPane._doQuery    BEFORE this._doLoadItems()");
			this._doLoadItems(this.items, dojo.hitch(this, "onItems"));
			console.log("plugins.dojox.layout._RollingListPane._doQuery    AFTER this._doLoadItems()");

		}else if(this.items){
			console.log("plugins.dojox.layout._RollingListPane._doQuery    BEFORE this.onItems()");
			this.onItems();
			console.log("plugins.dojox.layout._RollingListPane._doQuery    AFTER this.onItems()");
		}else{
			console.log("plugins.dojox.layout._RollingListPane._doQuery    BEFORE this._setContentAndScroll");
			this._setContentAndScroll(this.onFetchStart(), true);
			console.log("plugins.dojox.layout._RollingListPane._doQuery    AFTER this._setContentAndScroll");
		...
		console.log("plugins.dojox.layout._RollingListPane._doQuery    END");
	},
...
console.log("%cplugins/dojox/widget/_RollingListPane    COMPLETED", "color: blue");
