...
dojo.declare("dojox.widget._RollingListPane",
	...
	_load: function(){
		...
		console.log("%cplugins.dojox.layout.RollingList._load    START", "color: darkorange");
		...
		console.log("%cplugins.dojox.layout.RollingList._load    END", "color: darkorange");
	},
...
dojo.declare("dojox.widget.RollingList",
	...
	_onItemClick: function(/* Event */ evt, /* dijit._Contained */ pane, /* item */ item, /* item[]? */ children){
		...
		console.log("%cdojox.widget.RollingList._onItemClick    XXXXXXXXXXXXXXXXXXXXXXXXXxx item: ", "color: purple");
	...
	_setStore: function(/* dojo/data/api/Read */ store){
		...
		console.log("%cplugins.dojox.layout.RollingList._setStore    START", "color: darkorange");
		...
		console.log("%cplugins.dojox.layout.RollingList._setStore    END", "color: darkorange");
	},
	...
	startup: function(){
		...
		console.log("%cplugins.dojox.layout.RollingList.startup    START", "color: darkblue");
		...
		console.log("%cplugins.dojox.layout.RollingList.startup    DOING this._setStore(this.store)", "color: darkblue");
		...
		console.log("%cplugins.dojox.layout.RollingList.startup    END", "color: darkblue");
