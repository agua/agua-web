console.log("%cplugins.home.Home    LOADING", "font-size: large");
...
define([
	...
	// UPGRADE LOG
	"plugins/dojox/layout/FloatingPane",
...
templateString: dojo.cache("plugins", "home/templates/home.html"),
...
handleUpgrade : function (response) {
	console.log("Home.handleUpgrade    Home.handleUpgrade()");
	
},
updatePackage : function (packageObject) {
	console.log("Home.updatePackage    Home.updatePackage()");

	Agua.removePackage(packageObject);
	Agua.addPackage(packageObject);
	this.showCurrentVersion();
	
	// DISPLAY PROGRESS STOPPED	- SOMETHING LIKE THIS
...
stopProgress : function () {
	...
	// DISPLAY PROGRESS STOPPED - SOMETHIN LIKE THIS
	//dojo.attr(this.timer, 'isRunning', false);
},
...
pollProgress : function (url, version, packageObject) {
	...
	// TO DO: PUT PROGRESS IN PROGRESS PANE
	//
	this.progressPane.show();	
},
...
_onShow : function () {
	...
	setTimeout ( function () {
		...
		if ( reportedVersion )  {
			console.log("Home._onShow    reportedVersion is defined: " + reportedVersion);
			thisObject.stopProgress();
...
console.log("%cplugins.home.Home    COMPLETED", "font-size: large");
