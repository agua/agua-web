...
console.log("%cplugins.home.Controller    LOADING", "font-size: large");
...
templateString: dojo.cache("plugins", "home/templates/controller.html"),
...
console.log("%cplugins.home.Controller    COMPLETED", "font-size: large");
