/* DISPLAY THE USER'S OWN SOURCES DIRECTORY AND ALLOW THE USER TO BROWSE
...
console.log("%cplugins/folders/SourceFiles    LOADING", "color: blue");
...
console.log("%cplugins/folders/SourceFiles    COMPLETED", "color: blue");
