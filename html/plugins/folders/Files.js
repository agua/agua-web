...
console.log("%cplugins/folders/Files    LOADING", "color: blue");
...
define([
	...
	"plugins/dijit/layout/BorderContainer",
...
startup : function () {
	...
	if ( this.attachNode.addChild != null ) {
		...
		var projectFilesContainer = new LayoutContainer({ title: "Files" }, this.mainNode);
...
// LOAD FILESYSTEMS
	...
	console.group("Files    this: " + this);
	console.dir({this:this});

	var directories = this.getDirectories();
	console.group("Files    directories: " + directories);
...
// **** OVERRIDE THIS IN SUBCLASS ****
	console.log("Files.getData    this.id: " + this.id);
	console.log("Files.getData    directory:");
	console.dir({directory:directory});
	...
	data.sessionid	=	Agua.cookie('sessionid');
	data.path		=	directory.name;

	console.log("Files.getData    data: ");
...
// CREATE STORE FOR FILE DRAG
	...
	// SET URL
	var url 	= this.url;
	var data	= this.getData(directory);
...
console.log("%cplugins/folders/Files    COMPLETED", "color: blue");
