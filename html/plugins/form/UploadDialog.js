...
console.log("%cplugins/form/UploadDialog    LOADING", "color: blue");
...
templateString: dojo.cache("plugins", "form/templates/uploaddialog.html"),
...
startup : function () {
	...
	console.log("UploadDialog.startup    END");
},
clear : function () {
...
// HIDE THE DIALOGUE
	...
	this.dialog.onHide = function() {
	    ...
	    var underlay = registry.getEnclosingWidget(underlayNode);
...
console.log("%cplugins/form/UploadDialog    COMPLETED", "color: blue");
