...
//	[ dijit._Widget, dijit._Templated, plugins.form.EditForm, plugins.core.Common ],
//{
//
...
console.log("%cplugins/sharing/Projects    LOADING", "color: blue;");
...
templateString: dojo.cache("plugins", "sharing/templates/projects.html"),
...
console.log("%cplugins/sharing/Projects    COMPLETED", "color: blue;");
