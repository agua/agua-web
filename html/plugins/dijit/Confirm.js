...
console.log("%cplugins/dijit/Confirm    LOADING", "color: blue");

define("plugins/dijit/Confirm", [
	"dojo/_base/declare",
	"dijit/_Widget",
	"dijit/_Templated",
	"plugins/core/Common",
...
return declare("plugins/dijit/Confirm",
	[ _Widget, _Templated, Common ], {
	
// templateString : String
//		The template of this widget. 
templateString: dojo.cache("plugins", "dijit/templates/confirmdialog.html"),
...
console.log("%cplugins/dijit/Confirm    COMPLETED", "color: blue");
