...
console.log("%cplugins/dijit/SelectiveDialog    LOADING",  "color: blue");

define("plugins/dijit/SelectiveDialog", [
	"dojo/_base/declare",
...
return declare("plugins/dijit/SelectiveDialog",
	[ InteractiveDialog ], {

// templateString : String
//		The template of this widget. 
templateString: dojo.cache("plugins", "dijit/templates/selectivedialog.html"),


// OR USE @import IN HTML TEMPLATE
cssFiles : [
	require.toUrl("plugins/dijit/css/selectivedialog.css")
],
...
console.log("%cplugins/dijit/SelectiveDialog    COMPLETED",  "color: blue");
