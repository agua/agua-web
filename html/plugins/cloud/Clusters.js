...
console.log("%cplugins/cloud/Clusters    LOADING", "color: blue");
...
templateString: dojo.cache("plugins", "cloud/templates/clusters.html"),
...
cssFiles : [
	require.toUrl("plugins/cloud/css/clusters.css")
],
...
//	SAVE A PARAMETER TO Agua.parameters AND TO REMOTE DATABASE
	...
	inputs.cluster = Agua.getClusterLongName(inputs.cluster);
	//////console.log("Clusters.saveInputs    inputs: " + dojo.toJson(inputs));
	Agua.addCluster(inputs, this.id);
...
deleteItem : function (clusterObject) {
	...
	Agua.removeCluster(clusterObject, this.id);
...
console.log("%cplugins/cloud/Clusters    COMPLETED", "color: blue");
