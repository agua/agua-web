...
console.log("%cplugins/cloud/Settings    LOADING", "color: blue");
...
templateString: dojo.cache("plugins", "cloud/templates/settings.html"),
...
console.log("%cplugins/cloud/Settings    COMPLETED", "color: blue");
