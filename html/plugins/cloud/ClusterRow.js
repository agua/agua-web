console.log("%cplugins/cloud/ClusterRow    LOADING", "color: blue");
...
templateString: dojo.cache("plugins", "cloud/templates/clusterrow.html"),
...
console.log("%cplugins/cloud/ClusterRow    COMPLETED", "color: blue");
