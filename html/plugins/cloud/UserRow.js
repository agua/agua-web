...
console.log("%cplugins/cloud/UserRow    LOADING", "color: blue");
...
templateString: dojo.cache("plugins", "cloud/templates/userrow.html"),
...
console.log("%cplugins/cloud/UserRow    COMPLETED", "color: blue");
