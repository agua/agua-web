...
console.log("%cplugins/cloud/AmiRow    LOADING", "color: blue");
...
templateString: dojo.cache("plugins", "cloud/templates/amirow.html"),
...
console.log("%cplugins/cloud/AmiRow    COMPLETED", "color: blue");
