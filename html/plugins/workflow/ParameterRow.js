console.log("Loading plugins.workflow.ParameterRow");
...
templateString: dojo.cache("plugins", "workflow/templates/parameterrow.html"),
...
startup : function () {
	...
	console.log("ParameterRow.startup    BEFORE this.setBrowseButton()");
	this.setBrowseButton();
	console.log("ParameterRow.startup    AFTER this.setBrowseButton()");
...
setBrowseButton : function() {
	...
	dojo.connect(this.browseButton, "onclick", this, dojo.hitch( this, function(event) {
			console.log("ParameterRow.setBrowseButton    FIRED ONCLICK");
...
*/
	...
	console.log("ParameterRow.openFileManager     Agua.fileManager", Agua.fileManager);
	if ( ! Agua.fileManager ) {
...
// NB: RETURN NULL IF inputValue IS EMPTY OR NULL */
	...
	query.callback		=	"handleCheckfile",
