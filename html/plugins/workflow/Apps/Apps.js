/* DISPLAY APPLICATIONS AND ALLOW USER TO DRAG THEM TO WORKFLOWS */

console.log("plugins.workflow.Apps.Apps    LOADING");
...
startup : function () {
	console.log("Apps.Apps.startup    ");

	
	console.log("Apps.Apps.startup    this:");
	console.dir({this:this});
	
	
	console.log("Apps.Apps.startup    DOING this.attachPane()");
	this.mainTab.id = 
	this.attachPane();
...
console.log("plugins.workflow.Apps.Apps    COMPLETED");
