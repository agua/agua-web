...
console.log("%cplugins/workflow/GridWorkflow   LOADING", "color: blue; font-size: 12px");
...
templateString: dojo.cache("plugins", "workflow/templates/gridworkflow.html"),
...
setStages : function (stages) {
	...
	console.log("GridWorkflow.setStages     SETTING GridStage WIDGET FOR EACH NODE");
	...
	dojo.forEach(allNodes, function (node, i) {
		...
		// INSTANTIATE ROW 
		var gridStage = new GridStage(stages[i]);
	...
	console.log("GridWorkflow.setStages     END");
...
console.log("%cplugins/workflow/GridWorkflow   COMPLETED", "color: blue; font-size: 12px");
