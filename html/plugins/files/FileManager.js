console.log("%cplugins/files/FileManager    LOADING", "color: blue");
...
templateString: dojo.cache("plugins", "files/templates/filemanager.html"),
...
setMenus : function () {
	...
	this.fileMenu =   FileMenu({parentWidget : this});
...
createDialog : function () {
	...
	// CREATE DIALOGUE
	this.atomic.dialog = new FloatingPane ({
...
show : function (parameterWidget) {
	console.log("FileManager.show    parameterWidget", parameterWidget);
...
console.log("%cplugins/files/FileManager    COMPLETED", "color: blue");
