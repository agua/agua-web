...
// templateString: String, contents of template
...
// RELOAD FileDrag OBJECT INSIDE TITLE PANE	
	...
	console.log("TitlePane.reload    BEFORE this.core[" + master + "].createFileDrag()");
	var fileDrag = this.core[master].createFileDrag(this.directory);
	console.log("TitlePane.reload    AFTER this.core[" + master + "].createFileDrag()");
	console.log("TitlePane.reload    fileDrag: " + fileDrag);
	
	// ADD fileDrag TO TITLE PANE
	console.log("TitlePane.reload    BEFORE this.containerNode.appendChild(fileDrag.domNode)");
	this.containerNode.appendChild(fileDrag.domNode);	
	console.log("TitlePane.reload    AFTER this.containerNode.appendChild(fileDrag.domNode)");
},
clear : function () {
