...
cssFiles : [
	...
	require.toUrl("dojox/widget/RollingList/RollingList.css"),
	require.toUrl("plugins/files/FileDrag/FileDrag.css")
],
...
constructor: function (args){
	...
	//this.core = args.core;
	//this.path = args.path;
	console.log("FileDrag.constructor    END");
},
...
startup: function(){
	...
	console.log("FileDrag.startup    this:" + this);
	console.dir({this:this});
	
	// HACK TO SET WIDTH AND HEIGHT
	console.log("FileDrag.startup    BEFORE this.domNode.setAttribute()");
	...
	console.log("FileDrag.startup    AFTER this.domNode.setAttribute()");
	
	console.log("FileDrag.startup    BEFORE this.buttonsNode.setAttribute()");
	this.buttonsNode.setAttribute('style', 'display: none !important');
	console.log("FileDrag.startup    AFTER this.buttonsNode.setAttribute()");
...
//		////console.log("FileDrag.getPaneForItem	   item: " + item);
	...
	if ( !item || (this.store.isItem(item) && groupPanes) || this.store.getValue(item, "directory") )
	{
		...
		groupDragPane = new GroupDragPane({
			parentPath		: 	parentPath,
			path			: 	path,
	...
	//if(this.store.isItem(item) && ! this.store.getValue(item, "directory"))
	{
		...
		groupDragPane = new FileInfoPane({});
...
// GET parentPath FOR NEWLY CREATED GroupDragPane CHILD
