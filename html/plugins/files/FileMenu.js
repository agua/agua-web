...
//		Path to the template of this widget. 
templateString: dojo.cache("plugins", "files/templates/filemenu.html"),
...
// RELOAD RELEVANT DISPLAYS
	////console.log("workflow.Stages.updateWorkflows    workflow.Stages.updateWorkflows(args)");
	////console.log("workflow.Stages.updateWorkflows    args:");
	////console.dir(args);

	this.parentWidget.updateWorkflows();
},
// SELECT
...
// DOWNLOAD FILE FROM FOLDER
	...
	console.log("FileMenu.download     Doing IFrame.send(args))");
