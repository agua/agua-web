...
var util = declare("t/unit/html/doh", [], {

////}}}}}

identicalFields : function (hashA, hashB, fields) {
...
identicalHashes : function (hashA, hashB) {
	//console.log("identicalHashes    hashA:");
	//console.dir({hashA:hashA});
	//console.log("identicalHashes    hashB:");
	...
	//console.log("identicalHashes    Returning 1");
	return 1;
},
identicalObjectArrays : function (actuals, expecteds, key) {
	//console.log("identicalObjectArrays    actuals:");
	//console.dir({actuals:actuals});
	//console.log("identicalObjectArrays    expecteds:");
	...
	//console.log("identicalObjectArrays    Returning 1");
	return 1;
},
identicalOrderHashArrays : function (actuals, expecteds) {
	//console.log("identicalObjectArrays    actuals:");
	//console.dir({actuals:actuals});
	//console.log("identicalObjectArrays    expecteds:");
	//console.dir({expecteds:expecteds});
...
identicalArrays : function (actuals, expecteds) {
	//console.log("identicalArrays    actuals:");
	//console.dir({actuals:actuals});
	//console.log("identicalArrays    expecteds:");
	//console.dir({expecteds:expecteds});
	...
	//console.log("identicalArrays    Returning 1");
	return 1;
},
identicalArrayHashes : function (actuals, expecteds) {
	//console.log("identicalArrays    actuals:");
	//console.dir({actuals:actuals});
	//console.log("identicalArrays    expecteds:");
	//console.dir({expecteds:expecteds});
...
fetchJson : function(url) {
    ...
    dojo.xhrGet({
        ...
        error: function(response) {
            ...
            console.log("fetchJson    Error, response: ", response);
        }
    });
...
fetchText : function(url) {
	console.log("fetchJson    fetchText()");		
    ...
    dojo.xhrGet({
        ...
        // The error handler
        error: function() {
            console.log("fetchJson    Error, response: " + dojo.toJson(response));
        }
    });
...
//	console.log("t.unit.doh.util.fetchJson    url: " + url);
//
//    var jsonObject;
//    dojo.xhrGet({
//        // The URL of the request
...
//        // The success callback with result from server
//        load: function(response) {
//            console.log("t.unit.doh.util.fetchJson    response:");
