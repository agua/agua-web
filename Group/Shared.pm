...
=head2
	...
	PURPOSE
		...
		PROJECT AND RESOURCE SHARING METHODS FOR Web
...
=cut
	...
	my $select		=	shift;
	my $extra		=	shift;
	$self->logDebug("Web::Group::Shared::_sharedProjectStages()");
...
=cut
	...
	my $self		=	shift;
	$self->logDebug("Web::Group::Shared::getSharedStageParameters()");
...
=cut
	...
	#### 1. FIND THE SHARED SOURCES
	my $admin = $self->conf()->getKey($self->application(), 'ADMINUSER');
...
echo '{"sourceuser":"admin","targetuser":"syoung","sourceworkflow":"Workflow0","sourceproject":"Project1","targetworkflow":"Workflow9","targetproject":"Project1","username":"syoung","sessionid":"1234567890.1234.123","mode":"getData"}' |  ./workflow.cgi
